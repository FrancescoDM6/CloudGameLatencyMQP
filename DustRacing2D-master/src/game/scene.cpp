...
void Scene::processUserInput(InputHandler & handler)
{
    for (size_t i = 0; i < (m_game.hasTwoHumanPlayers() ? 2 : 1); i++)
    {
        ...
        //     m_cars.at(i)->accelerationAssist();
        // }
        // if (std::stof(m_game.getAssist()) == 0.1) {
        //     if (tickCount % 10 == 0) {
        ...
        //     }
        // }
        // if (std::stof(m_game.getAssist()) == 0.2) {
        ...
        //     }
        // }
        // if (std::stof(m_game.getAssist()) == 0.3) {
        ...
        //     }
        // }
        // if (std::stof(m_game.getAssist()) == 0.4) {
        ...
        //     }
        // }
        // if (std::stof(m_game.getAssist()) == 0.5) {
        ...
        //     }
        // }
        // if (std::stof(m_game.getAssist()) == 0.6) {
        ...
        //     }
        // }
        // if (std::stof(m_game.getAssist()) == 0.7) {
        //     if (tickCount % 10 == 0 || tickCount % 10 == 1 || tickCount % 10 == 2 || tickCount % 10 == 3 || tickCount % 10 == 4 || tickCount % 10 == 5
        //     || tickCount % 10 == 6) {
        //         const char* evlag = m_game.getEvLag();
        //         std::thread delayedUpdate([this, evlag, i]() {
        ...
        //     }
        // }
        // if (std::stof(m_game.getAssist()) == 0.8) {
        //     if (tickCount % 10 == 0 || tickCount % 10 == 1 || tickCount % 10 == 2 || tickCount % 10 == 3 || tickCount % 10 == 4 || tickCount % 10 == 5
        ...
        //     }
        // }
        // if (std::stof(m_game.getAssist()) == 0.9) {
        //     if (tickCount % 10 == 0 || tickCount % 10 == 1 || tickCount % 10 == 2 || tickCount % 10 == 3 || tickCount % 10 == 4 || tickCount % 10 == 5
        ...
        //     }
        // }
        // if (std::stof(m_game.getAssist()) == 1.0) {
        //         const char* evlag = m_game.getEvLag();
        //         std::thread delayedUpdate([this, evlag, i]() {
        //         std::this_thread::sleep_for(std::chrono::milliseconds(std::stoi(evlag)));
        //             m_cars.at(i)->steerAssist();
